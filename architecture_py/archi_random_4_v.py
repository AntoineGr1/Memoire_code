...
try:
    model = keras.models.Sequential([
		...
		keras.layers.Conv2D(256, kernel_size=7, strides=4, activation='sigmoid', padding='valid'),
		keras.layers.AveragePooling2D(pool_size=2, strides=4, padding='valid'),
		keras.layers.Conv2D(6, kernel_size=1, strides=2, activation='tanh', padding='same'),
		keras.layers.Conv2D(256, kernel_size=5, strides=1, activation='relu', padding='same'),
		keras.layers.Conv2D(1024, kernel_size=3, strides=2, activation='tanh', padding='valid'),
