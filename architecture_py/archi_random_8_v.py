...
try:
    model = keras.models.Sequential([
		...
		keras.layers.Conv2D(6, kernel_size=3, strides=1, activation='relu', padding='valid'),
		...
		keras.layers.Conv2D(36, kernel_size=2, strides=3, activation='selu', padding='same'),
		keras.layers.Flatten(),
		keras.layers.Dense(97, activation='relu'),
		keras.layers.Dense(67, activation='selu'),
