...
try:
    model = keras.models.Sequential([
		...
		keras.layers.Conv2D(6, kernel_size=5, strides=1, activation='selu', padding='valid'),
		keras.layers.MaxPooling2D(pool_size=5, strides=2, padding='same'),
		keras.layers.Conv2D(12, kernel_size=3, strides=3, activation='selu', padding='same'),
