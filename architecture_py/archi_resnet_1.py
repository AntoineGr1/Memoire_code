...
try:
    ...
    head_model = Dense(80, activation='selu')(head_model)
    head_model = Dense(58, activation='selu')(head_model)
    head_model = Dense(40, activation='tanh')(head_model)
    head_model = Dense(18, activation='selu')(head_model)
