...
try:
    ...
    head_model = Dense(3397, activation='tanh')(head_model)
    head_model = Dense(1207, activation='selu')(head_model)
    head_model = Dense(300, activation='tanh')(head_model)
    head_model = Dense(54, activation='selu')(head_model)
    ...
    plot_model(model, show_shapes=True, to_file="../architecture_img/archi_resnet_1.png")
    ...
    log_file = open("../architecture_log/archi_resnet_1.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_resnet_1.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_resnet_1_error.log has been create')
    error_file = open("../architecture_log/archi_resnet_1_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_resnet_1',  
