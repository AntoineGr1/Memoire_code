...
try:
    ...
    head_model = Dense(231, activation='relu')(head_model)
    head_model = Dense(32, activation='selu')(head_model)
    head_model = Dense(22, activation='relu')(head_model)
    head_model = Dense(18, activation='selu')(head_model)
    head_model = Dense(15, activation='selu')(head_model)
    ...
    log_file = open("../architecture_log/archi_resnet_10.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_resnet_10.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_resnet_10_error.log has been create')
    error_file = open("../architecture_log/archi_resnet_10_error.log" , "w")
