...
try:
    ...
    def ResNet():
        ...
        X = Conv2D(18, kernel_size=4, strides=2, activation='selu', padding='valid')(X)
    ...
    head_model = Dense(31, activation='tanh')(head_model)
    head_model = Dense(27, activation='relu')(head_model)
    ...
    plot_model(model, show_shapes=True, to_file="../architecture_img/archi_resnet_2.png")
    ...
    log_file = open("../architecture_log/archi_resnet_2.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_resnet_2.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_resnet_2_error.log has been create')
    error_file = open("../architecture_log/archi_resnet_2_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_resnet_2',  
