...
try:
    ...
    def ResNet():
        ...
        X = Conv2D(18, kernel_size=7, strides=2, activation='relu', padding='same')(X)
    ...
    head_model = Dense(899, activation='selu')(head_model)
    head_model = Dense(636, activation='relu')(head_model)
    head_model = Dense(255, activation='tanh')(head_model)
    head_model = Dense(178, activation='selu')(head_model)
    head_model = Dense(51, activation='selu')(head_model)
    head_model = Dense(16, activation='selu')(head_model)
    head_model = Dense(13, activation='relu')(head_model)
    head_model = Dense(10, activation='softmax')(head_model)
    model = Model(inputs=Input.input, outputs=head_model)
    plot_model(model, show_shapes=True, to_file="../architecture_img/archi_resnet_3.png")
    ...
    log_file = open("../architecture_log/archi_resnet_3.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_resnet_3.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_resnet_3_error.log has been create')
    error_file = open("../architecture_log/archi_resnet_3_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_resnet_3',  
