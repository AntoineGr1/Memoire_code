...
try:
    ...
    head_model = Dense(95, activation='tanh')(head_model)
    head_model = Dense(47, activation='tanh')(head_model)
    head_model = Dense(39, activation='tanh')(head_model)
    head_model = Dense(10, activation='softmax')(head_model)
    model = Model(inputs=Input.input, outputs=head_model)
    plot_model(model, show_shapes=True, to_file="../architecture_img/archi_resnet_4.png")
    ...
    log_file = open("../architecture_log/archi_resnet_4.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_resnet_4.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_resnet_4_error.log has been create')
    error_file = open("../architecture_log/archi_resnet_4_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_resnet_4',  
