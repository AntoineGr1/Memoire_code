...
try:
    ...
    def ResNet():
        ...
        X = Conv2D(18, kernel_size=3, strides=1, activation='selu', padding='same')(X)
    ...
    head_model = Dense(860, activation='tanh')(head_model)
    head_model = Dense(666, activation='relu')(head_model)
    head_model = Dense(537, activation='tanh')(head_model)
    head_model = Dense(133, activation='selu')(head_model)
    head_model = Dense(14, activation='relu')(head_model)
