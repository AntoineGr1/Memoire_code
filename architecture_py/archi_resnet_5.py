...
try:
    ...
    head_model = Dense(487, activation='tanh')(head_model)
    head_model = Dense(127, activation='selu')(head_model)
    head_model = Dense(104, activation='relu')(head_model)
    head_model = Dense(23, activation='relu')(head_model)
