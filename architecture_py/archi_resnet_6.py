...
try:
    ...
    head_model = Dense(76, activation='selu')(head_model)
    ...
    log_file = open("../architecture_log/archi_resnet_6.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_resnet_6.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_resnet_6_error.log has been create')
    error_file = open("../architecture_log/archi_resnet_6_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_resnet_6',  
