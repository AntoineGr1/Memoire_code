...
try:
    ...
    head_model = Dense(1300, activation='selu')(head_model)
    head_model = Dense(536, activation='selu')(head_model)
    head_model = Dense(198, activation='tanh')(head_model)
    head_model = Dense(152, activation='selu')(head_model)
    head_model = Dense(64, activation='relu')(head_model)
    head_model = Dense(39, activation='selu')(head_model)
    ...
    log_file = open("../architecture_log/archi_resnet_7.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_resnet_7.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_resnet_7_error.log has been create')
    error_file = open("../architecture_log/archi_resnet_7_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_resnet_7',  
