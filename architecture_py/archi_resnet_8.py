...
try:
    ...
    head_model = Dense(140, activation='tanh')(head_model)
    head_model = Dense(81, activation='selu')(head_model)
    head_model = Dense(70, activation='relu')(head_model)
    head_model = Dense(37, activation='relu')(head_model)
    head_model = Dense(21, activation='selu')(head_model)
