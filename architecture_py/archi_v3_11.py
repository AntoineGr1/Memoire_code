...
try:
    def getModel():
        ...
        X = conv_block(X, 3, 18, 'selu', 3)
        X = conv_block(X, 6, 36, 'tanh', 5)
        X = denseBlock(X, 2, 36, 3, 'same', 'relu')
        X = denseBlock(X, 2, 36, 3, 'same', 'relu')
        X = denseBlock(X, 2, 36, 3, 'same', 'relu')
        X = denseBlock(X, 2, 36, 3, 'same', 'relu')
    ...
    model = getModel()
    plot_model(model, show_shapes=True, to_file="../architecture_img/archi_v3_11.png")
    ...
    log_file = open("../architecture_log/archi_v3_11.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_v3_11.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_v3_11_error.log has been create')
    error_file = open("../architecture_log/archi_v3_11_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_v3_11',  
