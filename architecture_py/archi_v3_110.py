...
try:
    def getModel():
        ...
        X = Conv2D(36, kernel_size=5, strides=2, activation='relu', padding='valid')(X)
        X = id_block(X, 5, 36, 'selu')
    ...
    model = getModel()
    #plot_model(model, show_shapes=True, to_file="../architecture_img/archi_v3_110.png")
    ...
    log_file = open("../architecture_log/archi_v3_110.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_v3_110.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_v3_110_error.log has been create')
    error_file = open("../architecture_log/archi_v3_110_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_v3_110',  
