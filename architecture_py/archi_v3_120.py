...
try:
    def getModel():
        ...
        X = conv_block(X, 7, 18, 'selu', 7)
        X = conv_block(X, 2, 36, 'tanh', 1)
        X = conv_block(X, 5, 72, 'relu', 2)
        X = conv_block(X, 7, 144, 'selu', 3)
    ...
    model = getModel()
    #plot_model(model, show_shapes=True, to_file="../architecture_img/archi_v3_120.png")
    ...
    log_file = open("../architecture_log/archi_v3_120.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_v3_120.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_v3_120_error.log has been create')
    error_file = open("../architecture_log/archi_v3_120_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_v3_120',  
