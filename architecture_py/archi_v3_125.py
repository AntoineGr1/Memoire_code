...
try:
    def getModel():
        ...
        X = denseBlock(X, 7, 36, 1, 'same', 'selu')
        X = denseBlock(X, 7, 36, 1, 'same', 'selu')
        X = denseBlock(X, 7, 36, 1, 'same', 'selu')
        X = transition_block(X, 7, 36, 'same', 'selu', 'avg', 7)
        X = Flatten()(X)
    ...
    model = getModel()
    #plot_model(model, show_shapes=True, to_file="../architecture_img/archi_v3_125.png")
    ...
    log_file = open("../architecture_log/archi_v3_125.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_v3_125.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_v3_125_error.log has been create')
    error_file = open("../architecture_log/archi_v3_125_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_v3_125',  
