...
try:
    def getModel():
        ...
        X = Conv2D(72, kernel_size=2, strides=2, activation='relu', padding='valid')(X)
        X = MaxPooling2D(pool_size=2, strides=2, padding='valid')(X)
        X = Conv2D(144, kernel_size=6, strides=6, activation='selu', padding='same')(X)
        X = Conv2D(288, kernel_size=6, strides=3, activation='relu', padding='same')(X)
        X = Flatten()(X)
    ...
    model = getModel()
    #plot_model(model, show_shapes=True, to_file="../architecture_img/archi_v3_139.png")
    ...
    log_file = open("../architecture_log/archi_v3_139.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_v3_139.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_v3_139_error.log has been create')
    error_file = open("../architecture_log/archi_v3_139_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_v3_139',  
