...
try:
    def getModel():
        ...
        X = Conv2D(18, kernel_size=6, strides=6, activation='relu', padding='same')(X)
    ...
    model = getModel()
    #plot_model(model, show_shapes=True, to_file="../architecture_img/archi_v3_142.png")
    ...
    log_file = open("../architecture_log/archi_v3_142.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_v3_142.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_v3_142_error.log has been create')
    error_file = open("../architecture_log/archi_v3_142_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_v3_142',  
