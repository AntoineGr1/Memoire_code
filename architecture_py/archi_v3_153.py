...
try:
    def getModel():
        ...
        X = conv_block(X, 3, 36, 'tanh', 3)
        X = Flatten()(X)
        X = Dense(809, activation='selu')(X)
        X = Dense(360, activation='selu')(X)
        X = Dense(245, activation='relu')(X)
        X = Dense(10, activation='softmax')(X)
        model = Model(inputs=X_input, outputs=X)
        return model

    model = getModel()
    #plot_model(model, show_shapes=True, to_file="../architecture_img/archi_v3_153.png")
    ...
    log_file = open("../architecture_log/archi_v3_153.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_v3_153.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_v3_153_error.log has been create')
    error_file = open("../architecture_log/archi_v3_153_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_v3_153',  
