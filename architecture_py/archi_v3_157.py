...
try:
    def getModel():
        ...
        X = id_block(X, 3, 36, 'tanh')
        X = Conv2D(72, kernel_size=5, strides=4, activation='relu', padding='same')(X)
        X = Conv2D(144, kernel_size=6, strides=5, activation='relu', padding='same')(X)
        X = Flatten()(X)
    ...
    model = getModel()
    #plot_model(model, show_shapes=True, to_file="../architecture_img/archi_v3_157.png")
    ...
    log_file = open("../architecture_log/archi_v3_157.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_v3_157.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_v3_157_error.log has been create')
    error_file = open("../architecture_log/archi_v3_157_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_v3_157',  
