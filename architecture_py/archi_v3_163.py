...
try:
    def getModel():
        ...
        X = id_block(X, 5, 18, 'selu')
        X = id_block(X, 3, 18, 'relu')
        X = conv_block(X, 4, 36, 'tanh', 2)
        X = conv_block(X, 4, 72, 'relu', 2)
        X = id_block(X, 7, 72, 'tanh')
    ...
    model = getModel()
    #plot_model(model, show_shapes=True, to_file="../architecture_img/archi_v3_163.png")
    ...
    log_file = open("../architecture_log/archi_v3_163.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_v3_163.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_v3_163_error.log has been create')
    error_file = open("../architecture_log/archi_v3_163_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_v3_163',  
