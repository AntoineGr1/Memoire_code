...
try:
    ...
    model = getModel()
    #plot_model(model, show_shapes=True, to_file="../architecture_img/archi_v3_168.png")
    ...
    log_file = open("../architecture_log/archi_v3_168.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_v3_168.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_v3_168_error.log has been create')
    error_file = open("../architecture_log/archi_v3_168_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_v3_168',  
