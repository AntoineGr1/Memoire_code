...
try:
    def getModel():
        ...
        X = Conv2D(36, kernel_size=5, strides=2, activation='tanh', padding='valid')(X)
        X = denseBlock(X, 5, 36, 2, 'same', 'selu')
        X = denseBlock(X, 5, 36, 2, 'same', 'selu')
        X = transition_block(X, 5, 36, 'same', 'selu', 'max', 3)
    ...
    model = getModel()
    #plot_model(model, show_shapes=True, to_file="../architecture_img/archi_v3_180.png")
    ...
    log_file = open("../architecture_log/archi_v3_180.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_v3_180.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_v3_180_error.log has been create')
    error_file = open("../architecture_log/archi_v3_180_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_v3_180',  
