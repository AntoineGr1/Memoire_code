...
try:
    def getModel():
        ...
        X = denseBlock(X, 6, 36, 1, 'same', 'selu')
        X = transition_block(X, 6, 36, 'same', 'selu', 'max', 2)
        X = conv_block(X, 3, 72, 'selu', 2)
        X = Flatten()(X)
    ...
    model = getModel()
    plot_model(model, show_shapes=True, to_file="../architecture_img/archi_v3_2.png")
    ...
    log_file = open("../architecture_log/archi_v3_2.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_v3_2.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_v3_2_error.log has been create')
    error_file = open("../architecture_log/archi_v3_2_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_v3_2',  
