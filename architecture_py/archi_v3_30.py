...
try:
    def getModel():
        ...
        X = Conv2D(6, kernel_size=2, strides=1, activation='relu', padding='valid')(X)
        X = MaxPooling2D(pool_size=4, strides=2, padding='valid')(X)
        X = Conv2D(12, kernel_size=7, strides=5, activation='relu', padding='valid')(X)
        X = Conv2D(24, kernel_size=6, strides=4, activation='selu', padding='same')(X)
        X = Flatten()(X)
    ...
    model = getModel()
    plot_model(model, show_shapes=True, to_file="../architecture_img/archi_v3_30.png")
    ...
    log_file = open("../architecture_log/archi_v3_30.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_v3_30.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_v3_30_error.log has been create')
    error_file = open("../architecture_log/archi_v3_30_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_v3_30',  
