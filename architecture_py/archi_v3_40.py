...
try:
    def getModel():
        ...
        X = Conv2D(36, kernel_size=4, strides=3, activation='relu', padding='valid')(X)
        X = AveragePooling2D(pool_size=3, strides=1, padding='same')(X)
        X = Conv2D(72, kernel_size=3, strides=1, activation='relu', padding='same')(X)
    ...
    model = getModel()
    plot_model(model, show_shapes=True, to_file="../architecture_img/archi_v3_40.png")
    ...
    log_file = open("../architecture_log/archi_v3_40.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_v3_40.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_v3_40_error.log has been create')
    error_file = open("../architecture_log/archi_v3_40_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_v3_40',  
