...
try:
    def getModel():
        ...
        X = Conv2D(18, kernel_size=5, strides=2, activation='relu', padding='valid')(X)
        X = AveragePooling2D(pool_size=5, strides=5, padding='same')(X)
        X = Conv2D(36, kernel_size=6, strides=4, activation='tanh', padding='same')(X)
    ...
    model = getModel()
    plot_model(model, show_shapes=True, to_file="../architecture_img/archi_v3_44.png")
    ...
    log_file = open("../architecture_log/archi_v3_44.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_v3_44.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_v3_44_error.log has been create')
    error_file = open("../architecture_log/archi_v3_44_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_v3_44',  
