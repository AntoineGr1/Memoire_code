...
try:
    def getModel():
        ...
        X = Conv2D(18, kernel_size=5, strides=4, activation='selu', padding='valid')(X)
        ...
        X = Conv2D(144, kernel_size=3, strides=1, activation='relu', padding='valid')(X)
        X = Flatten()(X)
        X = Dense(102, activation='tanh')(X)
        X = Dense(10, activation='softmax')(X)
        model = Model(inputs=X_input, outputs=X)
        return model

    model = getModel()
    plot_model(model, show_shapes=True, to_file="../architecture_img/archi_v3_45.png")
    ...
    log_file = open("../architecture_log/archi_v3_45.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_v3_45.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_v3_45_error.log has been create')
    error_file = open("../architecture_log/archi_v3_45_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_v3_45',  
