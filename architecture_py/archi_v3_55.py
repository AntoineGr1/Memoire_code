...
try:
    def getModel():
        ...
        X = id_block(X, 4, 36, 'tanh')
        X = Flatten()(X)
        X = Dense(248, activation='relu')(X)
        X = Dense(215, activation='tanh')(X)
        X = Dense(165, activation='selu')(X)
        X = Dense(10, activation='softmax')(X)
        model = Model(inputs=X_input, outputs=X)
        return model

    model = getModel()
    plot_model(model, show_shapes=True, to_file="../architecture_img/archi_v3_55.png")
    ...
    log_file = open("../architecture_log/archi_v3_55.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_v3_55.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_v3_55_error.log has been create')
    error_file = open("../architecture_log/archi_v3_55_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_v3_55',  
