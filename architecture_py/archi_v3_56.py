...
try:
    def getModel():
        ...
        X = id_block(X, 7, 3, 'tanh')
        X = MaxPooling2D(pool_size=6, strides=5, padding='same')(X)
        X = id_block(X, 4, 3, 'tanh')
        X = Conv2D(18, kernel_size=6, strides=6, activation='selu', padding='valid')(X)
        X = Flatten()(X)
    ...
    model = getModel()
    plot_model(model, show_shapes=True, to_file="../architecture_img/archi_v3_56.png")
    ...
    log_file = open("../architecture_log/archi_v3_56.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_v3_56.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_v3_56_error.log has been create')
    error_file = open("../architecture_log/archi_v3_56_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_v3_56',  
