...
try:
    def getModel():
        ...
        X = Conv2D(18, kernel_size=4, strides=3, activation='tanh', padding='valid')(X)
        X = conv_block(X, 6, 36, 'tanh', 1)
    ...
    model = getModel()
    plot_model(model, show_shapes=True, to_file="../architecture_img/archi_v3_68.png")
    ...
    log_file = open("../architecture_log/archi_v3_68.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_v3_68.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_v3_68_error.log has been create')
    error_file = open("../architecture_log/archi_v3_68_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_v3_68',  
