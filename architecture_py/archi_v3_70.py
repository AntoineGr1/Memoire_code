...
try:
    def getModel():
        ...
        X = Conv2D(18, kernel_size=5, strides=3, activation='selu', padding='valid')(X)
        X = conv_block(X, 7, 36, 'selu', 2)
        X = id_block(X, 7, 36, 'tanh')
        X = conv_block(X, 7, 72, 'selu', 7)
    ...
    model = getModel()
    plot_model(model, show_shapes=True, to_file="../architecture_img/archi_v3_70.png")
    ...
    log_file = open("../architecture_log/archi_v3_70.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_v3_70.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_v3_70_error.log has been create')
    error_file = open("../architecture_log/archi_v3_70_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_v3_70',  
