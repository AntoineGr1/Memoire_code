...
try:
    def getModel():
        ...
        X = conv_block(X, 4, 18, 'relu', 4)
        X = conv_block(X, 5, 36, 'relu', 2)
        X = Conv2D(72, kernel_size=4, strides=3, activation='selu', padding='same')(X)
    ...
    model = getModel()
    plot_model(model, show_shapes=True, to_file="../architecture_img/archi_v3_71.png")
    ...
    log_file = open("../architecture_log/archi_v3_71.log" , "w")
    ...
    print('OK: file ../architecture_log/archi_v3_71.log has been create')
    
    nb_layers = len(model.layers)
    log_file.close()
except:
    print('error: file ../architecture_log/archi_v3_71_error.log has been create')
    error_file = open("../architecture_log/archi_v3_71_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'archi_v3_71',  
