...
try:
    ...
    plot_model(model, show_shapes=True, to_file="../architecture_img/architecture_valid.png")
    ...
    print('OK: file ../architecture_log/architecture_valid.log has been create')
    log_file = open("../architecture_log/architecture_valid.log" , "w")
    ...
    print('error: file ../architecture_log/architecture_valid_error.log has been create')
    error_file = open("../architecture_log/architecture_valid_error.log" , "w")
    ...
    with file: 
        ...
        # writer.writeheader() 
        writer.writerow({'file_name' : 'architecture_valid',  
